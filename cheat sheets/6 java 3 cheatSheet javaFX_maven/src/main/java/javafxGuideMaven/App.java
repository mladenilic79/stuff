...
public class App extends Application implements EventHandler<ActionEvent> {
    ...
    public void start(Stage primaryStage) {
    	...
    	/*
    	// default from javafx 13
        var javaVersion = SystemInfo.javaVersion();
        var javafxVersion = SystemInfo.javafxVersion();
        var label7 = new Label("Hello, JavaFX " + javafxVersion + ", running on Java " + javaVersion + ".");
        var scene = new Scene(new StackPane(label7), 640, 480);
        */
...
//        stage2.show();
        ...
        */
        ...
        Tab tab12 = new Tab("drawing");
        Tab tab13 = new Tab("canvas");
        // add tab
...
//        group.getChildren().add(btn);
        ...
        // Pane - drawing
        Pane paneDrawing = new Pane();
        // add to the tab
        tab12.setContent(paneDrawing);
        
        // Canvas - drawing
        Canvas canvasDrawing = new Canvas(480, 480);
        GraphicsContext gc = canvasDrawing.getGraphicsContext2D();
        // add to the tab
        tab13.setContent(canvasDrawing);
...
//        scenetitle.setFont(Font.font("Tahoma", FontWeight.NORMAL, 20));
        ...
        // reading (put in event handler?)
        String text_area = textArea.getText();
        ...
        // add rowspan & columnspan
        gridpane.add(tooltip_node, 4, 4, 2, 2);
        // tooltip node
        ...
        // underscore for mnemonic shortcut, optional, 
        // otherwise just put regular text
...
/*
webview doesn't work in javafx 13 missing dependancy from maven also
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
        //@@@@@ webview
...
//        column1.setVisible(false);
        ...
        */
        ...
        line.setEndY(-50);
        // add to pane
        paneDrawing.getChildren().addAll(line);
